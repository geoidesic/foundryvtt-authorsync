...
/**
 * Safely read a Foundry setting; returns defaultValue if game/settings not ready or key missing.
 * @param {string} module - Module id (e.g. MODULE_ID)
 * @param {string} key - Setting key (e.g. 'debug')
 * @param {*} defaultValue - Value to return when setting unavailable
